...
public class SwerveSubsystem extends SubsystemBase
{
  ...
  public SwerveSubsystem(SwerveDriveConfiguration driveCfg, SwerveControllerConfiguration controllerCfg)
  {
    ...
    // Calculated with SysID and averaged between modules
    replaceSwerveModuleFeedforward(0.1046795, 2.21215, 0.1471075);
  }
      ...
      AutoBuilder.configure(
          ...
          (speedsRobotRelative, moduleFeedForwards) -> {
            ...
            if (enableFeedforward)
            {
              swerveDrive.drive(
                  modifiedSpeeds,
                  swerveDrive.kinematics.toSwerveModuleStates(modifiedSpeeds),
  ...
  public void aimAtPositionWithLead(Translation2d position, double lead, boolean isPathPlanner) {
    ...
    aimOmega = -aimController.calculate(getPose().getRotation().getRadians() + (Math.PI/2), targetAngle.getRadians());
