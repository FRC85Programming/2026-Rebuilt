...
public class ShooterTable {
  ...
  static {
    ...
    hoodAngleMap.put(3.2, Rotation2d.fromDegrees(62));
    ...
    hoodAngleMap.put(5.13, Rotation2d.fromDegrees(55));
    hoodAngleMap.put(5.5, Rotation2d.fromDegrees(55));
    ...
    flywheelSpeedMap.put(5.49, 4600.0);
  }
