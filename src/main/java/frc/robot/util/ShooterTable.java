...
public class ShooterTable {
  ...
  static {
    ...
    hoodAngleMap.put(3.2, Rotation2d.fromDegrees(61));
    hoodAngleMap.put(3.6, Rotation2d.fromDegrees(59));
    hoodAngleMap.put(3.8, Rotation2d.fromDegrees(59));
    hoodAngleMap.put(4.28, Rotation2d.fromDegrees(60));
    hoodAngleMap.put(4.53, Rotation2d.fromDegrees(61));
    hoodAngleMap.put(4.63, Rotation2d.fromDegrees(62));
    hoodAngleMap.put(5.13, Rotation2d.fromDegrees(63));
    hoodAngleMap.put(5.5, Rotation2d.fromDegrees(63));
    ...
    flywheelSpeedMap.put(3.6, 4300.0);   // adjusted
    flywheelSpeedMap.put(3.8, 4500.0);   // adjusted
    ...
    flywheelSpeedMap.put(5.49, 5500.0);
  }
